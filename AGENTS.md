...
This file is the quick-reference operating contract for bytes-kotlin. The longer
...
bytes-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`bytes`](https://crates.io/crates/bytes). Upstream Rust is the behavioral oracle while the
